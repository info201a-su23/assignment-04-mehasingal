...
The problem domain of this dataset that I chose to study and analyze is the disproportionate makeup of prisons in the United States regarding the population and ratio of Black inmates to White inmates. I want to analyze the variations in ratios of Black to White inmates across prisons specifically, since this assignment is related to incarceration, so I'm only using the CSV file related to prison population per county/state. My variables of interest in this data set are year, state, total_prison_pop, black_prison_pop, and white_prison_pop. I specifically chose to only analyze the Black and White populations because Black people make up a disproportional amount in U.S prisons compared to White people, so observing how those ratios vary across states would help corroborate the findings showcased in the documentary 13th, while heavily focused on this unbalanced population ratio. 
